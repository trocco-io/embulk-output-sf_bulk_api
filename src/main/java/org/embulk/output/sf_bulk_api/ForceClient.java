...
public class ForceClient
{
    ...
    public ForceClient(final PluginTask pluginTask, final ErrorHandler errorHandler) throws ConnectionException
    {
    ...
    public long action(final List<SObject> sObjects) throws ConnectionException
    {
        ...
        default:
            throw new RuntimeException("Invalid actionType: " + actionType);
        }
    }
